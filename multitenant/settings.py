...
SECRET_KEY = '642==z0wy0j9n=3+1g!h1-k9gp9)la-ohp+#0^s)rh+0jk3zg&'
...
DATABASES = {
    'default': { 'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'multitenant_db_1',
        'USER':'postgres',
        'PASSWORD': 'admin123',
        'HOST': 'localhost',
        'PORT': '5432',},
    'deakin': { 'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'multitenant_db_2',
        'USER':'postgres',
        'PASSWORD': 'admin123',
        'HOST': 'localhost',
        'PORT': '5432',},
    'rmit': { 'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'multitenant_db_3',
        'USER':'postgres',
        'PASSWORD': 'admin123',
        'HOST': 'localhost',
        'PORT': '5432',},
